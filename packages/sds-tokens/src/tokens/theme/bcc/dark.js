  ...
  theme: {
    ...
    table: {
      ...
      row: {
        ...
        hover: {
          backgroundColor: { value: '{color.teal.20.value}', type: 'color' },
          textColor: { value: colorAliases.base, type: 'color' },
        },
        selected: {
          backgroundColor: { value: '{color.teal.20.value}', type: 'color' },
          textColor: { value: '{color.teal.70.value}', type: 'color' },
        },
        disabled: {
    ...
    chip: {
      ...
      variant: {
        ...
        primary: {
          backgroundColor: { value: '{color.teal.70.value}', type: 'color' },
          textColor: { value: colorAliases.white, type: 'color' },
          borderColor: { value: '{color.teal.70.value}', type: 'color' },
          hover: {
            backgroundColor: { value: '{color.teal.90.value}', type: 'color' },
            textColor: { value: colorAliases.white, type: 'color' },
        ...
        outline: {
          ...
          iconColor: { value: '{color.teal.70.value}', type: 'color' },
          hover: {
            backgroundColor: { value: '{color.teal.90.value}', type: 'color' },
            textColor: { value: colorAliases.white, type: 'color' },
            iconColor: { value: colorAliases.white, type: 'color' },
    ...
    dialog: {
      background: { value: colorAliases.neutral100, type: 'color' },
      textColor: { value: colorAliases.base, type: 'color' },
    ...
    button: {
      ...
      filled: {
        primary: {
          ...
          bg: { value: colorAliases.primary, type: 'color' },
          border: { value: colorAliases.primary, type: 'color' },
          hover: {
            text: { value: colorAliases.white, type: 'color' },
            icon: { value: colorAliases.white, type: 'color' },
            bg: { value: '{color.teal.90.value}', type: 'color' },
          },
          focus: {
            outline: { value: '{color.teal.20.value}', type: 'color' },
          },
        },
        secondary: {
    ...
    select: {
      ...
      trigger: {
        ...
        background: { value: colorAliases.neutral100, type: 'color' },
        borderColor: { value: colorAliases.neutral80, type: 'color' },
        selectedBorderColor: { value: '{color.teal.50.value}', type: 'color' },
        fontColor: { value: colorAliases.neutral10, type: 'color' },
        iconColor: { value: colorAliases.neutral10, type: 'color' },
        disabledColor: { value: colorAliases.neutral80, type: 'color' },
        focusColor: { value: '{color.teal.20.value}', type: 'color' },
        focusBorderColor: { value: '{color.teal.70.value}', type: 'color' },
      },
      item: {
        ...
        selected: {
          background: { value: '{color.teal.90.value}', type: 'color' },
          textColor: { value: '{color.teal.20.value}', type: 'color' },
    ...
    input: {
      ...
      focus: {
        borderColor: { value: colorAliases.primary, type: 'color' },
        boxShadowColor: { value: '{color.teal.60.value}', type: 'color' },
      },
      error: {
