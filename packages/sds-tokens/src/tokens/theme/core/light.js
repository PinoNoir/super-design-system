const colorAliases = {
  transparent: '{color.transparent.value}',
  ...
  inverted: '{color.neutral.5.value}',
...
const colors = {
  theme: {
    ...
    avatar: {
      ...
      text: { value: colorAliases.neutral10, type: 'color' },
    },
    chip: {
    ...
    card: {
      ...
      borderRadius: { value: '4px', type: 'radii' },
    },
    button: {
      ...
      outline: {
        primary: {
          ...
          border: { value: colorAliases.neutral100, type: 'color' },
          hover: {
            text: { value: colorAliases.white, type: 'color' },
            icon: { value: colorAliases.white, type: 'color' },
            bg: { value: colorAliases.neutral120, type: 'color' },
    ...
    select: {
      ...
      trigger: {
        ...
        fontColor: { value: colorAliases.primary, type: 'color' },
        iconColor: { value: colorAliases.primary, type: 'color' },
      ...
      item: {
        ...
        selected: {
          background: { value: colorAliases.neutral10, type: 'color' },
