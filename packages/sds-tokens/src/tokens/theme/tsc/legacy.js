...
const colors = {
  theme: {
    ...
    chip: {
      ...
      borderRadius: { value: '{border.radius.3}', type: 'radii' },
      height: { value: '{size.20}', type: 'size' },
      variant: {
        base: {
          ...
          hover: {
            backgroundColor: { value: colorAliases.neutral20, type: 'color' },
            textColor: { value: colorAliases.base, type: 'color' },
            iconColor: { value: colorAliases.error, type: 'color' },
          },
          disabled: {
    ...
    dialog: {
      ...
      borderRadius: { value: '{border.radius.0}', type: 'radii' },
