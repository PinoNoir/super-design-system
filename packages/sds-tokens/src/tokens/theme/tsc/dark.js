  ...
  theme: {
    ...
    select: {
      ...
      trigger: {
        ...
        selectedBorderColor: { value: '{color.cyan.50.value}', type: 'color' },
        fontColor: { value: colorAliases.neutral10, type: 'color' },
      ...
      item: {
        ...
        selected: {
          background: { value: '{color.cyan.90.value}', type: 'color' },
          textColor: { value: '{color.cyan.20.value}', type: 'color' },
          iconColor: { value: colorAliases.neutral120, type: 'color' },
        },
      },
      inputValue: {
    ...
    checkbox: {
      ...
      disabled: {
        ...
        background: { value: colorAliases.neutral60, type: 'color' },
        borderColor: { value: colorAliases.neutral60, type: 'color' },
        checkmarkColor: { value: colorAliases.neutral60, type: 'color' },
      },
    },
    input: {
      label: {
      ...
      focus: {
        borderColor: { value: colorAliases.primary, type: 'color' },
        boxShadowColor: { value: '{color.cyan.60.value}', type: 'color' },
      },
      error: {
