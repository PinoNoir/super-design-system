...
const colors = {
  theme: {
    ...
    table: {
      ...
      row: {
        even: {
          backgroundColor: { value: colorAliases.background, type: 'color' },
          hover: {
    ...
    button: {
      ...
      filled: {
        primary: {
          ...
          bg: { value: '{color.teal.70.value}', type: 'color' },
          border: { value: '{color.teal.70.value}', type: 'color' },
          hover: {
            text: { value: colorAliases.white, type: 'color' },
            icon: { value: colorAliases.white, type: 'color' },
      ...
      outline: {
        primary: {
          text: { value: '{color.teal.70.value}', type: 'color' },
          icon: { value: '{color.teal.70.value}', type: 'color' },
    ...
    select: {
      ...
      trigger: {
        ...
        selectedBorderColor: { value: '{color.teal.70.value}', type: 'color' },
      ...
      item: {
        ...
        selected: {
          background: { value: '{color.teal.10.value}', type: 'color' },
          textColor: { value: '{color.teal.70.value}', type: 'color' },
          iconColor: { value: '{color.teal.70.value}', type: 'color' },
        },
      },
    ...
    input: {
      ...
      focus: {
        borderColor: { value: colorAliases.primary, type: 'color' },
        boxShadowColor: { value: '{color.teal.20.value}', type: 'color' },
      },
      error: {
