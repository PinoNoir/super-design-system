const colorAliases = {
  ...
  primary: '{color.neutral.100.value}',
  secondary: '{color.neutral.40.value}',
  tertiary: '{color.blue.60.value}',
  accent: '{color.purple.50.value}',
  disabled: '{color.neutral.70.value}',
  help: '{color.magenta.50.value}',
  info: '{color.blue.50.value}',
  success: '{color.green.40.value}',
  warning: '{color.yellow.50.value}',
  error: '{color.red.40.value}',
  base: '{color.neutral.10.value}',
  inverted: '{color.neutral.100.value}',
  background: '{color.neutral.120.value}',
  foreground: '{color.neutral.100.value}',
  component: '{color.neutral.110.value}',
};
  ...
  Object.entries(colors).reduce((acc, [key, value]) => {
    ...
    if (typeof value === 'object' && value !== null) {
      Object.entries(value).forEach(([nestedKey, nestedValue]) => {
        acc[`${key}-${nestedKey}`] = { value: nestedValue, type: 'color' };
      });
    } else {
...
const colors = {
  theme: {
    ...
    border: createColorSet({
      base: colorAliases.neutral80,
      inverted: colorAliases.neutral10,
      info: colorAliases.info,
      success: colorAliases.success,
      warning: colorAliases.warning,
      error: colorAliases.error,
    ...
    avatar: {
      background: { value: colorAliases.neutral80, type: 'color' },
      text: { value: colorAliases.neutral20, type: 'color' },
    },
    chip: {
      ...
      variant: {
        ...
        primary: {
          backgroundColor: { value: '{color.blue.70.value}', type: 'color' },
          textColor: { value: colorAliases.white, type: 'color' },
          borderColor: { value: '{color.blue.70.value}', type: 'color' },
          hover: {
            backgroundColor: { value: '{color.blue.90.value}', type: 'color' },
            textColor: { value: colorAliases.white, type: 'color' },
        ...
        outline: {
          ...
          textColor: { value: '{color.blue.70.value}', type: 'color' },
          borderColor: { value: colorAliases.primary, type: 'color' },
          iconColor: { value: '{color.blue.70.value}', type: 'color' },
          hover: {
            backgroundColor: { value: '{color.blue.90.value}', type: 'color' },
            textColor: { value: colorAliases.white, type: 'color' },
            iconColor: { value: colorAliases.white, type: 'color' },
    ...
    table: {
      ...
      row: {
        even: {
          backgroundColor: { value: colorAliases.neutral90, type: 'color' },
          hover: {
            backgroundColor: { value: colorAliases.neutral80, type: 'color' },
          },
        },
        backgroundColor: { value: colorAliases.neutral100, type: 'color' },
        textColor: { value: colorAliases.base, type: 'color' },
        hover: {
          backgroundColor: { value: colorAliases.neutral80, type: 'color' },
          textColor: { value: colorAliases.neutral10, type: 'color' },
        },
        selected: {
          backgroundColor: { value: '{color.blue.20.value}', type: 'color' },
          textColor: { value: '{color.blue.80.value}', type: 'color' },
        },
        disabled: {
    ...
    dialog: {
      background: { value: colorAliases.primary, type: 'color' },
      textColor: { value: colorAliases.base, type: 'color' },
      borderColor: { value: colorAliases.neutral80, type: 'color' },
    ...
    navbar: {
      background: { value: colorAliases.primary, type: 'color' },
      bottomBorder: { value: colorAliases.neutral90, type: 'color' },
      hoverBorder: { value: colorAliases.neutral70, type: 'color' },
      text: { value: colorAliases.base, type: 'color' },
    },
    sidebar: {
      title: {
        textColor: { value: colorAliases.neutral40, type: 'color' },
      },
    },
    panel: {
      background: { value: colorAliases.primary, type: 'color' },
      text: { value: colorAliases.base, type: 'color' },
      borderColor: { value: colorAliases.neutral80, type: 'color' },
      topBorder: { value: colorAliases.neutral80, type: 'color' },
      borderWidth: { value: '{border.width.0}', type: 'size' },
      borderRadius: { value: '{border.radius.4}', type: 'radii' },
    ...
    card: {
      background: { value: colorAliases.primary, type: 'color' },
      text: { value: colorAliases.base, type: 'color' },
      topBorder: { value: colorAliases.neutral90, type: 'color' },
      border: { value: colorAliases.neutral80, type: 'color' },
    },
    button: {
      ...
      filled: {
        primary: {
          ...
          bg: { value: colorAliases.neutral120, type: 'color' },
          border: { value: colorAliases.neutral80, type: 'color' },
          hover: {
            text: { value: colorAliases.white, type: 'color' },
            icon: { value: colorAliases.white, type: 'color' },
            bg: { value: colorAliases.neutral90, type: 'color' },
          },
          focus: {
      ...
      outline: {
        primary: {
          ...
          hover: {
            text: { value: colorAliases.white, type: 'color' },
            icon: { value: colorAliases.white, type: 'color' },
            bg: { value: colorAliases.neutral100, type: 'color' },
          },
          focus: {
            outline: { value: colorAliases.neutral20, type: 'color' },
          },
    ...
    dropdown: {
      menu: {
        ...
        backgroundColor: { value: colorAliases.primary, type: 'color' },
        border: { value: colorAliases.neutral80, type: 'color' },
      ...
      item: {
        ...
        hover: {
          text: { value: colorAliases.neutral20, type: 'color' },
          icon: { value: colorAliases.neutral20, type: 'color' },
          bg: { value: colorAliases.neutral90, type: 'color' },
        },
        focus: {
    ...
    select: {
      label: {
        ...
        disabledColor: { value: colorAliases.neutral90, type: 'color' },
      ...
      trigger: {
        ...
        background: { value: colorAliases.primary, type: 'color' },
        borderColor: { value: colorAliases.neutral80, type: 'color' },
        selectedBorderColor: { value: colorAliases.primary, type: 'color' },
        fontColor: { value: colorAliases.neutral10, type: 'color' },
        iconColor: { value: colorAliases.neutral10, type: 'color' },
        disabledColor: { value: colorAliases.neutral80, type: 'color' },
        focusColor: { value: colorAliases.neutral20, type: 'color' },
        focusBorderColor: { value: colorAliases.primary, type: 'color' },
      },
      item: {
        ...
        focus: {
          background: { value: colorAliases.neutral90, type: 'color' },
        },
        selected: {
          background: { value: colorAliases.neutral90, type: 'color' },
          textColor: { value: colorAliases.neutral20, type: 'color' },
          iconColor: { value: colorAliases.neutral20, type: 'color' },
        },
      },
      inputValue: {
        color: { value: colorAliases.neutral10, type: 'color' },
      },
      menu: {
        background: { value: colorAliases.primary, type: 'color' },
    ...
    input: {
      ...
      height: { value: '{size.32}', type: 'size' },
      disabled: {
        textColor: { value: colorAliases.primary, type: 'color' },
        backgroundColor: { value: colorAliases.neutral80, type: 'color' },
        borderColor: { value: colorAliases.neutral90, type: 'color' },
      },
      focus: {
        borderColor: { value: '{color.blue.50.value}', type: 'color' },
        boxShadowColor: { value: '{color.blue.20.value}', type: 'color' },
      },
      error: {
        textColor: { value: '{color.red.40.value}', type: 'color' },
        backgroundColor: { value: colorAliases.component, type: 'color' },
        borderColor: { value: colorAliases.error, type: 'color' },
        boxShadowColor: { value: '{color.red.60.value}', type: 'color' },
      },
      success: {
        textColor: { value: '{color.green.40.value}', type: 'color' },
        backgroundColor: { value: colorAliases.component, type: 'color' },
        borderColor: { value: colorAliases.success, type: 'color' },
        boxShadowColor: { value: '{color.green.60.value}', type: 'color' },
      },
      warning: {
        textColor: { value: colorAliases.warning, type: 'color' },
        backgroundColor: { value: colorAliases.component, type: 'color' },
        borderColor: { value: colorAliases.warning, type: 'color' },
        boxShadowColor: { value: '{color.yellow.60.value}', type: 'color' },
      },
    },
  },
};
