    ...
    <>
      ...
      <div className={styles.main}>
        ...
        <ul className={styles.mainList}>
          ...
          <li>Actively maintained by Stretto&apos;s design and engineering teams</li>
        </ul>
        ...
        <p>
          Please checkout our{' '}
          <Link className={styles.link} href={'https://teamlink.stretto.com/display/CDS/FAQs'} target="_blank">
            FAQ
          </Link>{' '}
