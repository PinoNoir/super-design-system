...
import { useDataSearch, useDataSort, useRowSelection } from 'packages/cds-ui/src/hooks';
...
const meta: Meta<typeof Table> = {
  title: 'Components/Data Display/Data Table/Create Columns Method',
  component: Table,
  parameters: {
    design: {
      type: 'figma',
...
export const CreateColumnsMethod: Story = {
