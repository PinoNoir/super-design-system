...
describe('Footer Component', () => {
  ...
  it('renders footer with correct content', () => {
    ...
    expect(screen.getByText(/© \d{4} STRETTO\. All rights reserved\./)).toBeInTheDocument();
  });
  ...
  it('renders the current year in the copyright notice', () => {
    ...
    renderFooter();
    expect(screen.getByText(`© ${currentYear} STRETTO. All rights reserved.`)).toBeInTheDocument();
  });
});
