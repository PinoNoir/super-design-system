...
@import 'sds-ui/component-styles';
```
...
If you encounter any issues during migration, please open an issue and assign it to nickpino.designs@gmail.com or reach out to me directly via teams chat.
